  ...
  return (
    <footer>
        <div className="container footer__container">
            <article>
                ...
                <p>
                    ...
                    Ullam quisquam nulla optio quod recusandae ab odit quia doloremque ipsam consequatur.
                </p>
                <div className="footer__socials">
                    <a href="https://linkedin.com" target='_blank' rel='noreferer noopener'><FaLinkedin/></a>
                    <a href="https://facebook.com" target='_blank' rel='noreferer noopener'><FaFacebookF/></a>
        ...
        <div className="footer__copyright">
            <small>2023 KAKSY &copy; All Rights Reserved</small>
        </div>
    </footer>
  )
}
